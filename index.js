...
const TOKEN = 'MTMyMDc2MDM5NzM0MjU3MjU2NQ.G8m50e.Vs7P33ElSRs8fHjAeZ_2l2DHmv4MavO0oUjn-0'; // Replace with your bot token
const WEBHOOK_URL = 'https://discord.com/api/webhooks/1326684676601151538/1RW5N0b7Cdox12dMuJ8m8myKzt4ujf-L4oChjVkeijSyfD7Ke-9UMCydtyIl-dMqHplR'; // Replace with your webhook URL
const DATABASE_URL = 'postgresql://neondb_owner:uj0fBaYiL4zg@ep-small-sunset-a5sozxac.us-east-2.aws.neon.tech/neondb?sslmode=require'; // Replace with your PostgreSQL URL
const PORT = 3000;
...
(async () => {
    try {
        ...
        await rest.put(Routes.applicationCommands('1320760397342572565'), { body: commands });
...
client.on('interactionCreate', async (interaction) => {
    ...
    if (commandName === 'register') {
        ...
        const requiredRoleId = '1326630617311613033';
